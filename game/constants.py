...
PARTICLE_SPREAD_LINE = 2
PARTICLE_SPEED_MIN_LINE = 1
PARTICLE_SPEED_MAX_LINE = 3
PARTICLE_SIZE_MIN_LINE = 2
PARTICLE_SIZE_MAX_LINE = 5
PARTICLE_LIFETIME_MIN_LINE = 20
PARTICLE_LIFETIME_MAX_LINE = 40

PARTICLE_NUM_BOX = 20
PARTICLE_SPREAD_BOX = 3
PARTICLE_SPEED_MIN_BOX = 2
PARTICLE_SPEED_MAX_BOX = 5
PARTICLE_SIZE_MIN_BOX = 3
PARTICLE_SIZE_MAX_BOX = 8
PARTICLE_LIFETIME_MIN_BOX = 30
PARTICLE_LIFETIME_MAX_BOX = 60
